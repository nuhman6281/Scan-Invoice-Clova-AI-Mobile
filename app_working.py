"""
Working Donut Demo
Fixed version that properly handles CORD-v2 model output
"""
import argparse
import json
import gradio as gr
...
class WorkingDonutProcessor:
    """Working Donut processor that properly handles CORD-v2 output"""
    ...
    def load_model(self):
        ...
        # Load model without ignore_mismatched_sizes to avoid conflicts
        self.model = DonutModel.from_pretrained(self.model_path)
    ...
    def process_image(self, image):
        ...
        try:
            ...
            # Use the model.inference() method
        ...
        try:
            ...
            if not sequence:
                return {
                    ...
                    "error": "Model generated empty output"
                }
...
processor = WorkingDonutProcessor()
...
if __name__ == "__main__":
    ...
    demo = gr.Interface(
        ...
        inputs="image",
        outputs="text",
        title="🍩 Working Donut CORD-v2 Invoice Scanner",
